...
export class Consumer extends TypedEventEmitter {
    ...
    async receiveMessage(params) {
        try {
            ...
            throw toSQSError(err, `SQS receive message failed: ${err.message}`, this.extendedAWSErrors, this.queueUrl);
        }
    }
    /**
    ...
    async changeVisibilityTimeout(message, timeout) {
        try {
            ...
            this.emit("error", toSQSError(err, `Error changing visibility timeout: ${err.message}`, this.extendedAWSErrors, this.queueUrl, message), message);
        }
    }
    /**
    ...
    async executeHandler(message) {
        ...
        try {
            ...
            if (err instanceof TimeoutError) {
                throw toTimeoutError(err, `Message handler timed out after ${this.handleMessageTimeout}ms: Operation timed out.`, message);
            }
    ...
    async executeBatchHandler(messages) {
        try {
            ...
            if (err instanceof Error) {
                throw toStandardError(err, `Unexpected message handler failure: ${err.message}`, messages);
            }
            throw err;
        }
    }
    ...
    async deleteMessage(message) {
        ...
        try {
            ...
            throw toSQSError(err, `SQS delete message failed: ${err.message}`, this.extendedAWSErrors, this.queueUrl, message);
        }
    }
    /**
