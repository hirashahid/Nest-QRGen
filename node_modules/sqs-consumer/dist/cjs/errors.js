...
exports.TimeoutError = exports.StandardError = exports.SQSError = void 0;
 ...
 */
function getMessageIds(message) {
 ...
 */
function toSQSError(err, message, extendedAWSErrors, queueUrl, sqsMessage) {
 ...
 */
function toStandardError(err, message, sqsMessage) {
 ...
 * @param sqsMessage The message that was received from SQS.
 */
function toTimeoutError(err, message, sqsMessage) {
