...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: role_enum_1.ERole, unique: true, name: 'name' }),
...
__decorate([
    (0, typeorm_1.Column)({ nullable: true, default: 'web', name: 'guard_name' }),
    __metadata("design:type", String)
], Role.prototype, "guardName", void 0);
__decorate([
